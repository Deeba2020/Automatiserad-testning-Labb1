...
check if website opens correctly by waiting to see infotivCarRental
...
check if website opens correctly by waiting to see "When do you want to make your trip?"
...
check if website is open correctly by waiting to see field to enter email
