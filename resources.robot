...
open website and verify its correct website
    ...
    and website opens successfuly user is able to see infotivCarRental on the website
    then website opens successfuly user is able to see When do you want to make your trip? on the website
    and website opens successfuly to the right is the user information field to enter email
    then website opens successfuly to the right is the user information field to enter password
